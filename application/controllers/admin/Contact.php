...
class Contact extends BaseController
{
    ...
    public function index()
    {
        ...
        {        
			...
			$returns = $this->paginationCompress ( "contact/index", $count, 10 );
            
            $data['contactRecords'] = $this->contact_model->contactListing($searchText, $returns["page"], $returns["segment"]);
            
            $this->global['pageTitle'] = 'CodeInsect : Contact Listing';
            
            $this->loadAdminViews("contacts/index", $this->global, $data, NULL);
        }
    }
    ...
    function view($contactId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'View Contact';
            
            $this->loadAdminViews("contacts/view", $this->global, $data, NULL);
        }
    }
